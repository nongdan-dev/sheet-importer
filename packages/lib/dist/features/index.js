...
const Home = () => {
    const onSubmit = (jsonData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const mockOnAddField = (field) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (_jsx("div", { children: _jsx(SheetMappingData, { onSubmit: onSubmit, fields: [discountDetector, plantTypeDetector, priceDetector], onAddField: mockOnAddField }) }));
};
export default Home;
