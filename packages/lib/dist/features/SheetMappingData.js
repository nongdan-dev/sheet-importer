...
export const SheetMappingData = ({ onSubmit, fields = [], labels: propLabels = {} }) => {
  ...
  const handleSheetChange = (sheetName) => {
    ...
    const sheet =
      sheetDataMap === null || sheetDataMap === void 0 ? void 0 : sheetDataMap[sheetName]
    if (sheet) {
      setRowData(sheet.rowData || [])
      setColumnData(sheet.columnData || [])
    }
  }
  const labels = Object.assign(Object.assign(Object.assign({}, DEFAULT_LABELS), propLabels), {
    upload: Object.assign(Object.assign({}, DEFAULT_LABELS.upload), propLabels.upload),
    mapping: Object.assign(Object.assign({}, DEFAULT_LABELS.mapping), propLabels.mapping),
    validation: Object.assign(Object.assign({}, DEFAULT_LABELS.validation), propLabels.validation),
    confirmation: Object.assign(
      Object.assign({}, DEFAULT_LABELS.confirmation),
      propLabels.confirmation,
    ),
    common: Object.assign(Object.assign({}, DEFAULT_LABELS.common), propLabels.common),
  })
  ...
  return _jsxs('div', {
    className: 'w-full h-full flex-1 mx-auto font-sans',
    children: [
      ...
      activeTab !== STEP_VALIDATION.UPLOAD &&
        Object.keys(sheetDataMap || {}).length > 1 &&
        _jsxs('div', {
          className: 'mb-2 flex items-center gap-2',
          children: [
            _jsx('label', {
              className: 'text-sm font-medium whitespace-nowrap',
              children: labels.common.sheetLabel,
            }),
            _jsx('select', {
              className: 'border px-2 py-1 rounded text-sm w-auto',
              value: selectedSheet || '',
              onChange: (e) => handleSheetChange(e.target.value),
              children: Object.keys(sheetDataMap).map((sheetName) =>
                _jsx('option', { value: sheetName, children: sheetName }, sheetName),
              ),
            }),
          ],
        }),
      activeTab === STEP_VALIDATION.MAPPING &&
        _jsx(DataMappingStep, {
          ref: mappingStepRef,
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('span', { className: 'text-gray-500', children: getStepTitle(activeTab) }),
                _jsx('span', {
                  className: 'text-gray-500',
                  children: labels.common.stepIndicator(activeTab, 4),
                }),
              ],
            }),
            _jsx('button', {
              onClick: () => {
                ...
                if (activeTab === STEP_VALIDATION.MAPPING) {
                  ;(_b =
                    (_a = mappingStepRef.current) === null || _a === void 0
                      ? void 0
                      : _a.triggerRef) === null || _b === void 0
                    ? void 0
                    : _b.call(_a)
                } else {
                  ;(_d =
                    (_c = validationStepRef.current) === null || _c === void 0
                      ? void 0
                      : _c.refOnNext) === null || _d === void 0
                    ? void 0
                    : _d.call(_c)
                }
              },
