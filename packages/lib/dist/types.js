export const DEFAULT_LABELS = {
    ...
    mapping: {
        ...
        warnings: {
            ...
            duplicateColumn: (column, fields) => `Column "${column}" is mapped to multiple fields: ${fields.join(', ')}`,
        },
        alerts: {
            mapOneField: 'Please map at least one field before proceeding.',
            fieldCountDifference: 'There is a field count difference between the file and the system. Do you want to continue?',
        },
        buttons: {
            continue: 'Continue',
            addField: '+ Add Field',
