  ...
  const handleCellChange = useCallback(
    (e, rowIndex, field) => {
      ...
      if (field.validate) {
        ...
        if (validationResult.error) {
          setEditingErrors((prev) =>
            Object.assign(Object.assign({}, prev), { [inputKey]: validationResult.error || '' }),
          )
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        className: 'mb-6',
        children: [
          _jsx('p', { children: labels.stats.totalErrors(errors.length) }),
          _jsxs('p', {
            children: [
              'Current error ',
              errors.length > 0 ? currentErrorIndex + 1 : 0,
              '/',
              errors.length,
            ],
          }),
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('button', {
            ...
            className: `px-4 py-2 rounded-md shadow-sm text-sm font-medium text-white ${errors.length === 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}`,
            children: labels.buttons.nextError,
          }),
          _jsx('button', {
            onClick: handleDeleteAllErrorRows,
            disabled: errors.length === 0,
            className: `px-4 py-2 rounded-md shadow-sm text-sm font-medium text-white ${errors.length === 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-600 hover:bg-red-700'}`,
            children: labels.buttons.deleteAllErrors,
          }),
          _jsxs('label', {
            ...
            children: [
              ...
              _jsx('span', { children: 'Show error only' }),
            ],
          }),
        ],
      }),
        ...
        children: _jsxs('table', {
          ...
          children: [
                    ...
                    return _jsx(
                      'th',
                      {
                        ...
                        children: _jsx('div', {
                          ...
                          children: _jsx('span', { children: column.label || '' }),
                        }),
                      },
                      column.id,
                    )
            ...
            _jsx('tbody', {
              ...
              children: filteredData.map((row, rowIndex) => {
                return _jsx(
                  ValidationTableRow,
                  {
                    row: row,
