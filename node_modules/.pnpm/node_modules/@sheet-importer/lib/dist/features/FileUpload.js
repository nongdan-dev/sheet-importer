    ...
    children: [
      _jsxs(
        ...
        Object.assign({}, getRootProps(), {
          ...
          p-10`,
          children: [
            _jsx('input', Object.assign({}, getInputProps())),
            isProcessing
              ? _jsxs('div', {
                  className: 'space-y-2',
                  children: [
                    ...
                    _jsx('p', { className: 'text-gray-600', children: 'Processing file...' }),
                  ],
                })
              : _jsxs(_Fragment, {
                  children: [
                    ...
                    _jsxs('p', {
                      ...
                      children: [
                        'Supported formats: .xls, .xlsx, .csv (Max ',
                        maxFileSizeMB,
                        'MB)',
                      ],
                    }),
      ...
      fileName &&
        _jsx('div', {
          ...
          children: _jsxs('p', {
            className: 'text-sm',
            children: [
              _jsx('span', { className: 'font-medium', children: 'Selected file:' }),
              ' ',
              fileName,
              _jsxs('span', {
                className: 'text-gray-500 ml-2',
                children: ['(', (fileSize / 1024 / 1024).toFixed(2), ' MB)'],
              }),
            ],
          }),
        }),
      showModal &&
        _jsx(SheetSelectionModal, {
